...
export type ViewsIDType = 'search-view' | 'recent-view' | 'favorites-view' | 'profile-view'
export type PanelsIDType = SearchViewPanelsType | RecentViewPanelsType | FavoritesViewPanelsType | ProfileViewPanelsType
